...
@Component({
  selector: 'app-drstrangelove1964',
  templateUrl: './drstrangelove1964.component.html',
  styleUrls: ['./drstrangelove1964.component.scss']
})
export class Drstrangelove1964Component implements OnInit {
