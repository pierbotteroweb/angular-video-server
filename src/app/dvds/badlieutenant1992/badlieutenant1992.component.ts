...
@Component({
  selector: 'app-badlieutenant1992',
  templateUrl: './badlieutenant1992.component.html',
  styleUrls: ['./badlieutenant1992.component.scss']
})
export class Badlieutenant1992Component {
  ...
  ngOnInit(): void {
    ...
    this.data.dvd = "Bad Lieutenant 1992"
